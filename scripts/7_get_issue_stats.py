...
bugs_with_good_tf_idf_df = bugs_with_stats_df.sort_values(by="tf_idf", ascending=False).head(len(bugs_with_stats_df)//2)

top_k_dfs = []

#categories = ["stars", "tf_idf", "timelineCount", "issuesCount", "forkCount", "watchersCount", "discussionsCount"]
categories = ["tf_idf", "stars", "timelineCount", "issuesCount", "forkCount", "watchersCount", "discussionsCount"]
