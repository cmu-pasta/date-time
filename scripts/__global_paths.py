...
CLONE_REPOS_DIR = DATA_DIR + "cloned_repos4/"

REPOS_PATH = DATA_DIR + "repos.csv"
REPOS_WITH_DATETIME_PATH = DATA_DIR + "repos_with_datetime.csv"
DATETIME_REPOS_PATH = DATA_DIR + "filtered_repos.csv"
FILTERED_REPOS_PATH = DATA_DIR + "repos_with_grep_and_loc.csv"
